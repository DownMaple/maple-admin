  ...
  page: {
    ...
    manage: {
      ...
      role: {
        ...
        totalCount: 'Total',
        menuAuthTip: 'Catalog nodes are auto-filled, and half checked means only part of the child menus are granted.',
        buttonAuthTip: 'Button permissions only affect in-page actions and do not change the sidebar menu.',
        form: {
      ...
      menu: {
        ...
        form: {
          ...
          showInMenu: 'Please select whether to show menu',
          externalLink: 'Please select whether it is an external link',
